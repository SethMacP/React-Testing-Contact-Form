...
- [3 char name] You may have noticed that the form validation for one of the inputs is a little off...
- [James ] Write a test for the "expected" behavior (it will fail because something in the component is doing something unexpected)
- [Failed ] Confirm that the test fails, because of the "unexpected" behavior
- [see below ] Look at the code in the project to find what is causing the behavior
- [Added unique ID to grab element, removed maxlength... ] Fix the code so that your new test passes
